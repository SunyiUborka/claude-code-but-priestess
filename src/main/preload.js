...
contextBridge.exposeInMainWorld("petApi", {
  ...
  movePopoverDelta: (delta) => ipcRenderer.invoke("popover:move-delta", delta),
  moveEnd: () => ipcRenderer.invoke("popover:move-end"),
  ...
  moveDesktopPetDelta: (delta) => ipcRenderer.invoke("desktop-pet:move-delta", delta),
